...
Register-ArgumentCompleter -Native -CommandName sizes -ScriptBlock {
    ...
    switch ($prev) {
        ...
        '--max-files' { '1000','10000','100000','1000000' | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object { [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterValue', $_) }; return }
